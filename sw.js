const CACHE_NAME = 'mallikarjuna-temple-v1.0.0';
const urlsToCache = [
  '/',
  '/index.html',
...
self.addEventListener('push', (event) => {
  const options = {
    body: event.data ? event.data.text() : 'New update from Sri Mallikarjuna Temple',
  ...
  event.waitUntil(
    self.registration.showNotification('Sri Mallikarjuna Temple', options)
  );
});
